 ...
 */
func showSimplpAlertView(_ ctrol: UIViewController?, tl: String, msg: String, btnHiht: String = "确定", okHandle: block_alert? = nil) -> Void {
 ...
 */
func showAlertHandle(_ ctrol: UIViewController?, tl: String, cont: String, okHint: String?, cancelHint: String?, canlHandle: block_alert?, okHandle: block_alert?) -> Void {
	var uiCtrol = ctrol;
	if (uiCtrol == nil) {
		uiCtrol = UIApplication.shared.keyWindow?.rootViewController;
	}
...
func showSimpleInputAlert(_ ctrol: UIViewController?, title: String, placeholder: String, btnName: String, okHandle: bock_alertSimpleInput? = nil) {
	var uiCtrol = ctrol;
	if (uiCtrol == nil) {
		uiCtrol = UIApplication.shared.keyWindow?.rootViewController;
	}
...
func showLoginlert(_ uiCtrol: UIViewController?, txtName: String, pwd: String, loginHandle: block_alertLogin? = nil) -> UIAlertController {
